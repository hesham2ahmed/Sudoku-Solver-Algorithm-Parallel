...
namespace WindowsFormsApp1
{
    public partial class Form2 : Form
    {
       static int i = 0;
        ...
        public Form2(List<char[,]> solutions, double time_per_sol)
        {
         ...
         //   
            ...
            InitializeComponent();
            Solutions = solutions;
            fillBoard(solutions[i]); 
            i++;
            num_solutions.Text = solutions.Count+"";
            time_par.Text = time_per_sol+"  ms per solution";
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("There is no other solutions!");
            }
            else
            {
                fillBoard(Solutions[i]);
        ...
        private void num_solutions_Click(object sender, EventArgs e)
        {
        ...
        private void time_par_Click(object sender, EventArgs e)
        {
